...
import { ActiveParamsrUtil } from 'src/app/shared/utils/active-params.util';
...
export class CatalogComponent implements OnInit {
    ...
    this.categoryService.getCategoriesWithTypes()
      .subscribe(data => {
        ...
        this.activatedRoute.queryParams
          ...
          .subscribe(params => {
            this.activeParams = ActiveParamsrUtil.processParams(params);
  ...
  click(event: Event) {
    ...
    if (this.sortingOpen && !targetElement.closest('.catalog-sorting')) {
